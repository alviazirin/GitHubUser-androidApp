...
class AlarmReceiver : BroadcastReceiver() {
    ...
    companion object {
        const val SETALARM = "SetAlarm"
        const val EXTRA_TITLE = "Hello There"
        const val EXTRA_MESSAGE = "TaPP here and get back to this app already"

        private const val ID_SETALARM = 911
    ...
    private fun showAlarmNotification(context: Context, title: String?, message: String?, notifId: Int){
        ...
        val builder = NotificationCompat.Builder(context, CHANNEL_ID)
                ...
                .setSmallIcon(R.drawable.ic_notification_important_white_48dp)
